 ...
 */
@Controller(
    route = "/application/GWT",
    selector = "content",
    componentInterface = IGWTComponent.class,
    component = GWTComponent.class
)
public class GWTController extends AbstractComponentController<GWTContext, IGWTComponent, HTMLElement> implements IGWTComponent.Controller {
  ...
  public void start() {
    ...
    model = new MyModel("This value is set using the edit method! The value is >> 1 <<");
    // 
...
//    eventBus.fireEvent(new StatusChangeEvent("active screen: >>GWT<<"));
  }
